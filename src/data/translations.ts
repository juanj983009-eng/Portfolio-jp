...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    hero: {
      badge: "ANÁLISIS DE DATOS · DESARROLLO DE SOFTWARE",
      heroRole: "ANALISTA DE DATOS Y DESARROLLADOR DE SOFTWARE",
      marquee:
        "JUAN PARRA — ANALISTA DE DATOS Y DESARROLLADOR DE SOFTWARE — PORTAFOLIO —",
      profileFocus: "PROYECTOS ACADÉMICOS Y PERSONALES",
      heroTitle: {
        main: "DATOS PARA DECIDIR. ",
        highlight: "SOFTWARE PARA RESOLVER.",
      },
      description:
        "Analizo y organizo datos para convertirlos en información útil. También desarrollo aplicaciones con Python, Java, React y SQL para resolver flujos operativos y de negocio.",
    ...
    about: {
      ...
      metric1Label: "SOFTWARE",
      metric1Value: "Java · React · APIs",
      metric2Label: "DATOS",
      metric2Value: "SQL · Python · Power BI",
      metric3Label: "OPERACIONES",
      metric3Value: "Procesos industriales · CNC",
      moreAboutMeBtn: "MÁS SOBRE MÍ",
      biographyTag: "// BIOGRAFÍA",
      biographyLead:
        "Construyo soluciones de software y análisis de datos que conectan procesos, información y experiencia de usuario. Trabajo con Python, SQL, Power BI, Java, React y bases de datos relacionales y NoSQL. Mi experiencia en procesos industriales fortaleció mi criterio para comprender operaciones, identificar información relevante y traducir necesidades en flujos de software.",
      biographyBody:
        "Ingeniería de Sistemas — UTP · Séptimo ciclo · Tercio superior",
      yearsExp: "INGENIERÍA DE SISTEMAS · SÉPTIMO CICLO",
  ...
  en: {
    ...
    hero: {
      badge: "DATA ANALYSIS · SOFTWARE DEVELOPMENT",
      heroRole: "DATA ANALYST & SOFTWARE DEVELOPER",
      marquee:
        "JUAN PARRA — DATA ANALYST & SOFTWARE DEVELOPER — PORTFOLIO —",
      profileFocus: "ACADEMIC AND PERSONAL PROJECTS",
      heroTitle: {
        main: "DATA FOR DECISIONS. ",
        highlight: "SOFTWARE FOR SOLUTIONS.",
      },
      description:
        "I analyze and organize data to turn it into useful information. I also build applications with Python, Java, React, and SQL to solve operational and business workflows.",
    ...
    about: {
      ...
      metric2Label: "DATA",
      metric2Value: "SQL · Python · Power BI",
      metric3Label: "OPERATIONS",
      metric3Value: "Industrial processes · CNC",
      moreAboutMeBtn: "MORE ABOUT ME",
      biographyTag: "// BIOGRAPHY",
      biographyLead:
        "I build software and data-analysis solutions that connect processes, information, and user experience. I work with Python, SQL, Power BI, Java, React, and relational and NoSQL databases. My experience with industrial processes strengthened my ability to understand operations, identify relevant information, and translate needs into software workflows.",
      biographyBody:
        "Systems Engineering — UTP · Seventh term · Top third of class",
      yearsExp: "SYSTEMS ENGINEERING · SEVENTH TERM",
      educationBadgeValue: "UTP",
